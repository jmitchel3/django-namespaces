...
class Namespace(models.Model):
    ...
    handle = models.SlugField(help_text='Namespaces must be unique across this website.', 
    ...
    def get_absolute_url(self):
        ...
        """
        return resolvers.reverse('django_namespaces:detail-update', kwargs={'handle': self.namespace})
    ...
    def get_activation_url(self):
        ...
        Review django_namespaces.resolvers for more
        """
        return resolvers.reverse('django_namespaces:activate', kwargs={'handle': self.namespace})
    ...
    def get_delete_url(self):
        ...
        Review django_namespaces.resolvers for more
        """
        return resolvers.reverse('django_namespaces:delete', kwargs={'handle': self.namespace})
