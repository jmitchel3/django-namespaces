...
class SettingsTests(TestCase):
    ...
    def test_default_settings(self):
        ...
        self.assertEqual(s.DJANGO_NAMESPACE_MODEL, "django_namespaces.models.Namespace")
        self.assertEqual(
            s.DJANGO_NAMESPACE_BLOCKED_LIST_LOCATION,
            "django_namespaces.blocked.blocked_namespaces",
        )
        self.assertEqual(
            s.DJANGO_NAMESPACE_NEEDS_ACTIVATION_TEMPLATE,
            "django_namespaces/namespace_needs_activation.html",
        )
        self.assertEqual(s.DJANGO_NAMESPACE_MAX_HANDLE_LENGTH, 50)
        self.assertEqual(
            s.DJANGO_NAMESPACE_CREATE_FORM,
            "django_namespaces.forms.NamespaceCreateForm",
        )
        self.assertEqual(
            s.DJANGO_NAMESPACE_UPDATE_FORM,
    ...
    @override_settings(
        DEFAULT_NAMESPACE_MODEL="custom.Model",
        DJANGO_NAMESPACE_BLOCKED_LIST_LOCATION="custom.blocked",
        DJANGO_NAMESPACE_NEEDS_ACTIVATION_TEMPLATE="custom/template.html",
        DJANGO_NAMESPACE_MAX_HANDLE_LENGTH=100,
        DJANGO_NAMESPACE_CREATE_FORM="custom.CreateForm",
    ...
    def test_custom_settings(self):
        ...
        self.assertEqual(s.DJANGO_NAMESPACE_MODEL, "custom.Model")
        self.assertEqual(s.DJANGO_NAMESPACE_BLOCKED_LIST_LOCATION, "custom.blocked")
        self.assertEqual(
            s.DJANGO_NAMESPACE_NEEDS_ACTIVATION_TEMPLATE, "custom/template.html"
        )
        self.assertEqual(s.DJANGO_NAMESPACE_MAX_HANDLE_LENGTH, 100)
        self.assertEqual(s.DJANGO_NAMESPACE_CREATE_FORM, "custom.CreateForm")
